...
// ==========================================
const teamMembers = [
    { name: "Charan R. Shetty", role: "President", department: "core", photo: "images/members/charan.jpg" },
    { name: "Kedar Guruv", role: "Vice President", department: "core", photo: "images/members/kedar.jpg" },
    { name: "Komal Shrike", role: "Design Lead", department: "design", photo: "images/members/komal.jpg" },
    { name: "Parth M. Narse", role: "Technical Lead", department: "technical", photo: "images/members/parth.jpg" },
    { name: "Nidhee S. Jadhav", role: "Management Lead", department: "management", photo: "images/members/nidhee.jpg" },
    { name: "Bhagyesh Joshi", role: "Management Co-Lead", department: "management", photo: "images/members/bhagyesh.jpg" },
    { name: "Kshitija Khilari", role: "Technical Lead", department: "technical", photo: "images/members/kshitija.jpg" },
    { name: "Purva Atigre", role: "Design Co-Lead", department: "design", photo: "images/members/purva.jpg" },
    { name: "Aditya Shrike", role: "Documentation Lead", department: "documentation", photo: "images/members/aditya.jpg" },
    { name: "Anushka Sonavane", role: "Documentation Co-Lead", department: "documentation", photo: "images/members/anushka.jpg" },
    { name: "Chinmay Chiplunkar", role: "Media Lead", department: "media", photo: "images/members/chinmay.jpg" },
    { name: "Payal Hasbe", role: "Media Lead", department: "media", photo: "images/members/payal.jpg" }
];
    ...
    container.innerHTML = filtered.map(member => `
        <div class="bg-cyberCard border border-slate-800 rounded-2xl p-6 text-center hover:border-neonCyan/50 transition-all">
            <img src="${member.photo}" alt="${member.name}" 
                 onerror="this.onerror=null; this.src='https://via.placeholder.com/150/0f172a/00f2fe?text=User';" 
                 class="w-24 h-24 mx-auto mb-3 rounded-full object-cover border-2 border-slate-700">
